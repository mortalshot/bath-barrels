						...
						echo '<div class="main-catalog__filter catalog-filter">';
							echo '<div class="catalog-filter__item" data-category="">';
								echo '<div class="checkbox">';
									echo '<input id="catalog-filter-0" class="checkbox__input" type="radio" value="Все" name="catalog-filter">';
							...
							foreach ($terms as $term) :
								echo '<div class="catalog-filter__item" data-category="'. $term -> slug .'">';
									echo '<div class="checkbox">';
										echo '<input id="catalog-filter-'. $j .'" class="checkbox__input" type="radio" value="'. $term -> name .'" name="catalog-filter" '. ($term -> slug == $currentCategory ? 'checked' : '') .'>';
